"""add 'updated_at' for companions'


Revision ID: 748d3ad72043
Revises:
Create Date: 2025-04-02 23:06:07.869920
...
def downgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            postgresql.ENUM(
                "confirmed", "pending", "declined", "canceled", name="companionstatus"
            ),
            autoincrement=False,
            nullable=False,
        ),
        ...
        sa.ForeignKeyConstraint(
            ["companion_id"], ["account.id"], name="companions_companion_id_fkey"
        ),
        sa.ForeignKeyConstraint(
            ["trip_id"], ["trip.id"], name="companions_trip_id_fkey"
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["companion_id"], ["account.id"], name="companion_companion_id_fkey"
        ),
        sa.ForeignKeyConstraint(
            ["trip_id"], ["trip.id"], name="companion_trip_id_fkey"
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "arrival_date", postgresql.TIMESTAMP(), autoincrement=False, nullable=True
        ),
        sa.Column(
            "departure_date", postgresql.TIMESTAMP(), autoincrement=False, nullable=True
        ),
        sa.Column(
            "created_at", postgresql.TIMESTAMP(), autoincrement=False, nullable=False
        ),
        sa.ForeignKeyConstraint(
            ["trip_id"], ["trip.id"], name="itineraries_trip_id_fkey"
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["sender_id"], ["account.id"], name="message_sender_id_fkey"
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["trip_id"], ["trip.id"], name="itinerary_trip_id_fkey"
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            postgresql.ENUM(
                "planned", "in_progress", "completed", "canceled", name="tripstatus"
            ),
            autoincrement=False,
            nullable=True,
        ),
        sa.ForeignKeyConstraint(
            ["initiator_id"], ["account.id"], name="trip_initiator_id_fkey"
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["sender_id"], ["account.id"], name="messages_sender_id_fkey"
        ),
